...
<?php
    if(isset($_GET['error'])) {
        if($_GET['error'] === 'invdate') {
          echo '<script>alert("Sai ngày sinh")</script>';
      } else if($_GET['error'] === 'moblen') {
          echo '<script>alert("Sai sdt")</script>';
...
<main>
    ...
    <div class="col-md-12 main-col">
        <h1 class="text-center text-secondary">THÔNG TIN HÀNH KHÁCH</h1>  
        ...
        <?php for($i=1;$i<=$passengers;$i++) {
            ...
            <div class="form-row">
                ...
                <div class="col-md">
                    <div class="input-group">
                        <label for="midname'.$i.'">Tên đệm</label>
                ...
                <div class="col-md">
                    <div class="input-group">
                        <label for="lastname'.$i.'">Tên</label>
